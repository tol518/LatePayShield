# GPT/Codex Instructions — LatePay Shield

Read [`PROJECT_CONTEXT.md`](./PROJECT_CONTEXT.md) in full before planning, coding, reviewing, or suggesting architecture. Treat it as the canonical project and hackathon brief for this repository. This file is the GPT/Codex counterpart to `CLAUDE.md`.
